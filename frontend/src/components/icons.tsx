...
export const StarIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M12 2.5l2.9 5.9 6.6.9-4.8 4.6 1.1 6.5L12 17.8 6.2 20.9l1.1-6.5L2.5 9.3l6.6-.9L12 2.5z" />
  </svg>
);
...
export const SearchDataIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <circle cx="11" cy="11" r="7" />
...
export const UsersIcon = (p: IconProps) => (
  <svg {...base(p)}>
    ...
    <path d="M2.5 21v-1a5 5 0 0 1 5-5h3a5 5 0 0 1 5 5v1" />
    <path d="M16 5.5a3.5 3.5 0 0 1 0 6.9M22 21v-1a5 5 0 0 0-3.8-4.85" />
  </svg>
);
...
export const SettingsIcon = (p: IconProps) => (
  <svg {...base(p)}>
    ...
    <path d="M19.4 15a1.6 1.6 0 0 0 .3 1.8l.1.1a2 2 0 1 1-2.8 2.8l-.1-.1a1.6 1.6 0 0 0-2.7 1.1V21a2 2 0 1 1-4 0v-.1a1.6 1.6 0 0 0-2.7-1.1l-.1.1a2 2 0 1 1-2.8-2.8l.1-.1a1.6 1.6 0 0 0-1.1-2.7H1a2 2 0 1 1 0-4h.1a1.6 1.6 0 0 0 1.1-2.7l-.1-.1a2 2 0 1 1 2.8-2.8l.1.1a1.6 1.6 0 0 0 1.8.3H7a1.6 1.6 0 0 0 1-1.5V1a2 2 0 1 1 4 0v.1a1.6 1.6 0 0 0 2.7 1.1l.1-.1a2 2 0 1 1 2.8 2.8l-.1.1a1.6 1.6 0 0 0-.3 1.8V7a1.6 1.6 0 0 0 1.5 1H23a2 2 0 1 1 0 4h-.1a1.6 1.6 0 0 0-1.5 1z" />
  </svg>
);
...
export const TrashRestoreIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M3 6h18M8 6V4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6" />
...
export const ListChecksIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M3 5.5 4.5 7 7 4M3 12l1.5 1.5L7 11M3 18.5 4.5 20 7 17M11 6h10M11 12h10M11 18h10" />
  </svg>
);
...
export const BarChartIcon = (p: IconProps) => (
  <svg {...base(p)}>
    ...
    <rect x="12.4" y="7" width="3.2" height="10" rx="1" />
    <rect x="17.8" y="13" width="3.2" height="4" rx="1" />
  </svg>
);
...
export const SortIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M7 4v16M7 20l-3-3M7 4l3 3M17 20V4M17 4l-3 3M17 4l3 3" />
  </svg>
);
